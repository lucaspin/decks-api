...
Re-shuffles the cards still in the deck into a new random order, and marks the deck as shuffled. Cards that have already been drawn are not affected and are not brought back into the deck.
