...
Re-shuffles the cards currently remaining in the deck (i.e. the ones not yet drawn) and marks the deck as shuffled. This does not add back any cards that were already drawn.
