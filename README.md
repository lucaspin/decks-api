...
Shuffles the cards currently remaining in the deck, in place. This does not change how many cards are in the deck - if cards have already been drawn from it, only the remaining ones are shuffled. The deck is also marked as shuffled.
