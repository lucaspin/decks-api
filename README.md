...
Re-shuffles an existing deck in place: the deck keeps its ID, but the order of the cards still in it is randomized and the deck is marked as shuffled. Cards that were already drawn are not returned to the deck.
