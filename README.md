...
Re-shuffles the cards currently remaining in the deck (i.e. cards already drawn are not brought back into the deck) and persists the new order. The deck is marked as shuffled.
