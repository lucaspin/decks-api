...
Re-shuffling a deck randomizes the order of the cards still left in the deck, and marks the deck as shuffled. Cards that have already been drawn do not come back to the deck.
