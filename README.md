...
Re-shuffles the cards currently in the deck, in place. This does not change which cards are in the deck or how many of them remain - it only changes their order - and it marks the deck as shuffled, regardless of its previous state.
