...
Re-shuffles the deck in place: it randomizes the order of the cards currently remaining in the deck (if some cards have already been drawn, only what is left is reshuffled) and marks the deck as shuffled.
