...
Re-shuffles the cards that are still in the deck and marks it as shuffled. Note that cards that were already drawn from the deck are **not** restored; only the remaining cards are reordered.
