...
Re-shuffles the cards currently remaining in the deck, in place. This does not change which cards are in the deck, only their order, and it works the same way regardless of whether the deck had already been drawn from.
